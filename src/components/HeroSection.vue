  ...
  <header id="hero">
    <div class="hero-layout">
      <div class="hero-left">
        ...
        <p class="hero-desc">在 Minecraft 中内置多种超分辨率算法，包括 FSR、DLSS、XeSS 等。通过降低实际渲染分辨率，再由算法将画面重建回原分辨率，以可接受的画质损失换取帧率提升；也可将超分比例设低于 1.0，相当于高质量抗锯齿，提升画面清晰度。</p>
            ...
            <div class="logo-wrapper">
              ...
              <svg class="mod-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <g class="logo-shapes">
                  ...
                  <polygon class="p-4" points="41.4 80.73 45.84 59.84 38.71 59.84 34.27 80.73 41.4 80.73"/>
                </g>
              </svg>
            </div>
          </div>
